...
# Allow your specific main domains explicitly
CORS(app, supports_credentials=True, origins=["https://vercel.app", "http://localhost:5500"])

# Automatically approve any preview link generated by your Vercel project
@app.after_request
def handle_cors_preflight(response):
    origin = request.headers.get('Origin')
    if origin:
        # This matches your production domain AND all your automatic Vercel preview links
        if "vercel.app" in origin and "spendsmart" in origin:
